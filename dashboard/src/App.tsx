  ...
  return (
    <div className="flex min-h-screen bg-bg">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {accountsApi.data === null && accountsApi.loading && (
          <div className="flex-1 p-6 space-y-4">
            <div className="h-8 w-1/3 animate-pulse bg-border rounded-lg" />
            <div className="h-32 w-full animate-pulse bg-border rounded-lg" />
            <div className="h-48 w-full animate-pulse bg-border rounded-lg" />
          </div>
        )}
