  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 p-6">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div>
          <h2 className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">RSS Feeds</h2>
          <p className="text-xs text-gray-500 mb-3">Manage Red Hat blog and press release feeds</p>
          <RSSFeedsManagementSection />
        </div>
      </div>
    </div>
  )
