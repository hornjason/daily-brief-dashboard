...
### Customer Intelligence — Deep Account Views

Every customer gets an 81-point health score, strategic motion analysis, AI-generated account briefs, and 134+ signals tracked across 23 data sources. Tabs for Overview, Playbook, Campaigns, Meeting Prep, Tech Stack, News, and Intelligence.

<img src="docs/images/customer-intelligence.png" alt="Customer Intelligence View" width="800" />

### Strategic Motions — AI-Powered Sales Plays

The intelligence engine cross-references your customer's tech stack, support cases, subscriptions, cloud spend, and pipeline to generate strategic sales plays. Each motion has phases (Anchor, Expand, Transform) with evidence-backed tactics and estimated TCV.
...
| <img src="docs/images/customer-intelligence.png" width="400" /> | **Customer Detail** — Health score, strategic motion, signals, account brief |
| <img src="docs/images/strategic-motion.png" width="400" /> | **Strategic Motion** — Evidence-backed phases with tactics and recommendations |
