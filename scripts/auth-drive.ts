/**
 * One-time auth flow for Google Drive.
 * Run: bun scripts/auth-drive.ts
...
const TOKEN_PATH  = `${CONFIG}/.gdrive-server-credentials.json`

const REDIRECT_PORT = 9001
...
const server = createServer(async (req, res) => {
  ...
  try {
    ...
    res.end('<h2 style="font-family:sans-serif">✅ Drive authorized — you can close this tab.</h2>')
