...
ENV_EXAMPLE_URL="https://github.com/hornjason/daily-brief-dashboard/releases/latest/download/default.env.example"
COMPOSE_URL="https://github.com/hornjason/daily-brief-dashboard/releases/latest/download/docker-compose.yml"
