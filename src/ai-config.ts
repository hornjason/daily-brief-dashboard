...
export interface AiConfig {
  ...
  modelOverrides: Record<string, string>  // callType → 'full' | 'lite' | 'pro' — per-module model override
}

export const DEFAULT_AI_CONFIG: AiConfig = {
  geminiModel: 'gemini-3.5-flash',
  geminiModelLite: 'gemini-3.1-flash-lite',
  briefSynthesisTemperature: 0.3,
  ...
  modelOverrides: {},                 // empty = no overrides, use caller-specified defaults
}
