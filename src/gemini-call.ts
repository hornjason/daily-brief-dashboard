...
const LONG_FORM_CALL_TYPES = new Set(['campaign-generation', 'campaign-selection', 'account-plan', 'value-positioning', 'daily-briefing-synthesis', 'enhanced-tactic-recommendation'])
