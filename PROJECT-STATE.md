...
| `/dashboard/customer/:name` | CustomerDetailPage | ✅ Working | v2.0 redesign: slim header (health popover, Meeting Prep), left column (Brief → Sales Strategy → AI Opportunities → What Changed → Deep Dive), 3 sidebar groups (Opportunities, People, Account Data), floating Q&A widget |
