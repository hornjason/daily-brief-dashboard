/**
 * Unit tests for background-scheduler timer logic.
 *
 * Focuses on nextEt2amUtc DST edge cases:
...
import { nextEt2amUtc } from '../src/background-scheduler.ts'

describe('nextEt2amUtc', () => {
  ...
  // nextEt2amUtc called before the transition (1:50am EST = 6:50am UTC)
  ...
  // nextEt2amUtc called before the first 2am (1:30am EDT = 5:30am UTC)
